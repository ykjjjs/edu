...
app.get('/api/health', (c) => {
  return c.json({ status: 'ok', version: 'v9.0-webdo-auth' })
})
...
<title>WebDo - Web Service Academy</title>
...
<div id="loginScreen">
  <div class="login-card">
    ...
    <div class="login-title">Web<span>Do</span></div>
    ...
    <div class="login-note">Google 계정으로 안전하게 로그인됩니다</div>
...
<div id="appShell">
  <nav class="topbar">
    <div style="display:flex;align-items:center;gap:10px;">
      ...
      <div class="topbar-logo">
        ...
        <span class="logo-accent">Do</span>
      </div>
    </div>
    <div class="topbar-right">
      <div class="top-pct"><span class="pct-ring"></span>전체 <b id="topPct">0%</b></div>
      <img class="user-av-img" id="userAvImg" src="" alt="" style="display:none">
  ...
  <footer class="site-footer">
    <div class="footer-inner">
      <span class="footer-copy">&copy; 2026. WebDo (Yeon Je-jin) All rights reserved.</span>
    </div>
  </footer>
</div>
